# Generated by Powerlevel10k configuration wizard on 2020-02-13 at 08:43 PST.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 46907.
# Wizard options: nerdfont-complete + powerline, small icons, lean_8colors, 2 lines,
# solid, no frame, white-ornaments, sparse, many icons, concise, transient_prompt.
